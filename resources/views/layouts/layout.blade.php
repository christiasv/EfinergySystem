...
<head>
    ...
    <title>Efinergy Consultora</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('img/ico/isotipo.ico')}}">
    <link rel="shortcut icon" type="image/png" href="{{asset('img/ico/isotipo.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendors/css/card.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->
...
<div class="wrapper">
    ...
    <div data-active-color="white" data-background-color="man-of-steel" data-image="{{asset('img/sidebar-bg/01.jpg')}}" class="app-sidebar">
        <!-- main menu header-->
        <!-- Sidebar Header starts-->
        <div class="sidebar-header">
            <div class="logo clearfix"><a href="/index" class="logo-text float-left">
                    <div class="logo-img"><img src="{{asset('img/logo.png')}}"/></div><span class="text align-middle">EFINERGY</span></a><a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block"><i data-toggle="expanded" class="toggle-icon ft-toggle-right"></i></a><a id="sidebarClose" href="javascript:;" class="nav-close d-block d-md-block d-lg-none d-xl-none"><i class="ft-x"></i></a></div>
        </div>
        <!-- Sidebar Header Ends-->
        <!-- / main menu header-->
        <!-- main menu content-->
        <div class="sidebar-content">
            <div class="nav-container">
                <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                    <li class=" nav-item active"><a href="#"><i class="ft-home"></i><span data-i18n="" class="menu-title">Inicio</span></a>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-feather"></i><span data-i18n="" class="menu-title">Empresa</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                        <ul class="menu-content">
                            <li><a href="../../admin/slide" class="menu-item">Empresas</a></li>
                            <li><a href="../../admin/nosotros" class="menu-item">Areas</a></li>
                            <li><a href="../../admin/equipo" class="menu-item">Cargos</a></li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-book"></i><span data-i18n="" class="menu-title">Academico</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                        <ul class="menu-content">
                            <li><a href="../../admin/slide" class="menu-item">Proyectos</a></li>
                            <li><a href="../../admin/nosotros" class="menu-item">Cursos</a></li>
                            <li><a href="../../admin/equipo" class="menu-item">Salones</a></li>
                            <li><a href="../../admin/noticia" class="menu-item">Matriculas</a></li>
                        </ul>
                    </li>
                    <li class="has-sub nav-item"><a href="#"><i class="ft-settings"></i><span data-i18n="" class="menu-title">Enrolado</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                        <ul class="menu-content">
                            <li><a href="../../admin/slide" class="menu-item">Proyectos</a></li>
                            <li><a href="../../admin/nosotros" class="menu-item">Nosotros</a></li>
                            <li><a href="../../admin/equipo" class="menu-item">Equipo</a></li>
                    ...
                    <li class=" nav-item"><a href=""><i class="ft-activity"></i><span data-i18n="" class="menu-title">Estadisticas</span></a>
                    </li>
                    <li class=" nav-item"><a href=""><i class="ft-mail"></i><span data-i18n="" class="menu-title">Inbox</span></a>
                    </li>
                    <li class=" nav-item"><a href="../registros/usuarios"><i class="ft-users"></i><span data-i18n="" class="menu-title">Usuarios</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <form role="search" class="navbar-form navbar-right mt-1">
                    <div class="position-relative has-icon-right">
                        <input type="text" placeholder="Buscar" class="form-control round"/>
            ...
            <div class="navbar-container">
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item mr-2 d-none d-lg-block"><p class="dropdown-item">Nombre de usuario</p></li>
                        ...
                        <!--<li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-flag font-medium-3 blue-grey darken-4"></i><span class="selected-language d-none"></span></a>
                            <div class="dropdown-menu dropdown-menu-right text-left"><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('img/flags/us.png')}}" class="langimg"/><span> English</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('img/flags/es.png')}}" class="langimg"/><span> Spanish</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('img/flags/br.png')}}" class="langimg"/><span> Portuguese</span></a><a href="javascript:;" class="dropdown-item"><img src="{{asset('img/flags/de.png')}}" class="langimg"/><span> French</span></a></div>
                        </li>-->
                    ...
                    <div id="chat-tab" aria-labelledby="base-tab2" class="tab-pane">
                        <div id="chatapp" class="col-12">
                            ...
                            <div class="collection border-none">
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-12.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-6.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-11.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-18.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-1.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-2.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-3.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-15.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-19.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-14.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-13.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-22.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-9.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="{{asset('img/portrait/small/avatar-s-20.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="rtl-icon" href="" target="_blank" class="bg-dark customizer-toggle"><span class="font-medium-1 white align-middle">RTL</span></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row sb-bg-img">
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/01.jpg')}}" width="90" class="rounded sb-bg-01"></div>
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/02.jpg')}}" width="90" class="rounded sb-bg-02"></div>
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/03.jpg')}}" width="90" class="rounded sb-bg-03"></div>
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/04.jpg')}}" width="90" class="rounded sb-bg-04"></div>
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/05.jpg')}}" width="90" class="rounded sb-bg-05"></div>
            <div class="col-sm-2 mb-3"><img src="{{asset('img/sidebar-bg/06.jpg')}}" width="90" class="rounded sb-bg-06"></div>
        </div>
        <hr>
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('vendors/js/core/jquery-3.2.1.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/core/popper.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/core/bootstrap.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/perfect-scrollbar.jquery.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/prism.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/jquery.matchHeight-min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/screenfull.min.js')}}" type="text/javascript"></script>
<script src="{{asset('vendors/js/pace/pace.min.js')}}" type="text/javascript"></script>
<!-- BEGIN VENDOR JS-->
<!-- BEGIN PAGE VENDOR JS-->
<script src="{{asset('vendors/js/chartist.min.js')}}" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
